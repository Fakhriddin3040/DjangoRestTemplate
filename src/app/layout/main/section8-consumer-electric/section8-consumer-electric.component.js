...
exports.Section8ConsumerElectricComponent = void 0;
...
var Section8ConsumerElectricComponent = function () {
    ...
    var _classThis;
    var Section8ConsumerElectricComponent = _classThis = /** @class */ (function () {
        function Section8ConsumerElectricComponent_1(renderer, platformId) {
            this.renderer = renderer;
            this.platformId = platformId;
            this.scriptLoaded = false;
        }
        Section8ConsumerElectricComponent_1.prototype.ngOnInit = function () {
            var _this = this;
        ...
        Section8ConsumerElectricComponent_1.prototype.ngAfterViewInit = function () {
        ...
        Section8ConsumerElectricComponent_1.prototype.initializeSwiper = function () {
            if (window['Swiper']) {
        ...
        return Section8ConsumerElectricComponent_1;
    }());
    __setFunctionName(_classThis, "Section8ConsumerElectricComponent");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        Section8ConsumerElectricComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Section8ConsumerElectricComponent = _classThis;
}();
exports.Section8ConsumerElectricComponent = Section8ConsumerElectricComponent;
