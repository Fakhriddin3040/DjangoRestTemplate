...
exports.Section7ComputerTechologiesComponent = void 0;
...
var Section7ComputerTechologiesComponent = function () {
    ...
    var _classThis;
    var Section7ComputerTechologiesComponent = _classThis = /** @class */ (function () {
        function Section7ComputerTechologiesComponent_1(renderer, platformId) {
            this.renderer = renderer;
            this.platformId = platformId;
            this.scriptLoaded = false;
        }
        Section7ComputerTechologiesComponent_1.prototype.ngOnInit = function () {
            var _this = this;
        ...
        Section7ComputerTechologiesComponent_1.prototype.ngAfterViewInit = function () {
        ...
        Section7ComputerTechologiesComponent_1.prototype.initializeSwiper = function () {
            if (window['Swiper']) {
        ...
        return Section7ComputerTechologiesComponent_1;
    }());
    __setFunctionName(_classThis, "Section7ComputerTechologiesComponent");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        Section7ComputerTechologiesComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Section7ComputerTechologiesComponent = _classThis;
}();
exports.Section7ComputerTechologiesComponent = Section7ComputerTechologiesComponent;
