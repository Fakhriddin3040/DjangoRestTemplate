...
urlpatterns = [
    ...
    path(
        "email_registration/step1", user_views.UserEmailStep1RegisterAPIView.as_view()
    ),
    path(
        "email_registration/step2", user_views.UserEmailStep2RegisterAPIView.as_view()
    ),
    path(
        "email_registration/step3", user_views.UserEmailStep3RegisterAPIView.as_view()
    ),
